...
let owners = '1204876472708235270'//ايدي الي هيتحول 
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '1204876472708235270'
  owner.unshift('1204876472708235270')//اي دي حقك
}
updateAdmins()
...
client.on('guildCreate', guild => {
  ...
  let textList = ["Shop Ball" , `${prefix}help` , "Shop Ball"] 
        ...
        message.channel.awaitMessages({
          ...
          message.author.send({
            embeds: [new Discord.MessageEmbed()
              ...
              .setTimestamp()
              .setDescription(`**Hi ${message.author.tag} , you have buy ${numOfAcc} ${account} project ${numOfAcc > 1 ? "s" : ""}:**
> **Total price : \`${tax * numOfAcc}\`**
          **Your Link ${numOfAcc > 1 ? "s" : ""}:**
